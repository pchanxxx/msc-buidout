...
from kss.core.tests.base import KSSViewFunctionalTestCase
...
def afterSetUp(self):
    KSSViewFunctionalTestCase.afterSetUp(self)
...
def test_suite():
    ...
    suites.append(FunctionalDocFileSuite('../actionwrapper.py',
                                         ...
                                         setUp=afterSetUp,
                                         tearDown=KSSViewFunctionalTestCase.beforeTearDown.im_func))
